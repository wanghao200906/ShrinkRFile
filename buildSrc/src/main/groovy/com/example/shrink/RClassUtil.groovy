...
class RClassUtil {
            ...
            ClassVisitor classVisitor = new ClassVisitor(Opcodes.ASM5) {
                ...
                FieldVisitor visitField(int access, String name, String desc, String signature, Object value) {
                    if (value instanceof Integer) {
                        if(fullClassName.contains("styleable")){
                            println "123";
                        }
     ...
     * @param classFile
     */
    static void replaceAndDeleteRInfo(File classFile, ShrinkRFileExtension extension) {
        ...
        if (isRFileExceptStyleable(classFile.getAbsolutePath())) {
            ShrinkRFileExtension.KeepRInfo keepRInfo = extension.shouldKeepRFile(fullClassName)
            if (keepRInfo != null) {
...
//                }
     ...
     * @param extension
     */
    static void replaceAndDeleteRInfoFromJar(File srcJar, ShrinkRFileExtension extension) {
            ...
            MethodVisitor visitMethod(int access, String name, String desc, String signature, String[] exceptions) {
                ...
                methodVisitor = new MethodVisitor(Opcodes.ASM5, methodVisitor) {
                    ...
                    void visitFieldInsn(int opcode, String owner, String name1, String desc1) {
                        String key = "compileDebugJavaWithJavac/classes/"+owner + name1
