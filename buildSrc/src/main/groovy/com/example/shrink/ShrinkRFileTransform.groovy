 ...
 * 对R文件进行瘦身
 */
class ShrinkRFileTransform extends Transform {

    Project project
    ShrinkRFileExtension extension

    ShrinkRFileTransform(Project project) {
        this.project = project
    }

    @Override
    String getName() {
        return "ShrinkRFileTransform"
    }
    ...
    void transform(Context context, Collection<TransformInput> inputs, Collection<TransformInput> referencedInputs, TransformOutputProvider outputProvider, boolean isIncremental) throws IOException, TransformException, InterruptedException {
        extension = project.extensions.getByName("shrinkRConfig")

        println "----------------------------------"
        println "------ShrinkRFileTransform start-----"
        ...
        println "------ShrinkRFileTransform end-------"
        println "----------------------------------"
    }
